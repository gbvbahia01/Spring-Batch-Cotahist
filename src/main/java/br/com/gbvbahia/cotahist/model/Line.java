...
public class Line {
    ...
    * UTILIZADO PARA CLASSIFICAR OS PAPEIS NA EMISSAO DO BOLETIM DIARIO DE
    * INFORMACOES <br>
    * VTA
    */
   ...
   /**
    * PREEXE - PRECO DE EXERCICIO PARA O MERCADO DE OPCOES OU VALOR DO CONTRATO
    * PARA O MERCADO DE TERMO SECUNDARIO
    */
   // @FileMap(order = 20, start = 189, length = 13, fraction = 100)
   private BigDecimal preExe;

   /**
    * INDOPC - INDICADOR DE CORRECAO DE PRECOS DE EXERCICIOS OU VALORES DE CONTRATO
    * PARA OS MERCADOS DE OPCOES OU TERMO SECUNDARIO <br>
    * VTA
    */
   ...
   /**
    * DATVEN - DATA DO VENCIMENTO PARA OS MERCADOS DE OPCOES OU TERMO
    * SECUNDARIO<br>
    * FORMATO "AAAAMMDD"
    */
   ...
   /**
    * PTOEXE - PRECO DE EXERCICIO EM PONTOS PARA OPCOES REFERENCIADAS EM DOLAR OU
    * VALOR DE CONTRATO EM PONTOS PARA TERMO SECUNDARIO<br>
    * PARA OS REFERENCIADOS EM DOLAR, CADA PONTO EQUIVALE AO VALOR, NA MOEDA
    * CORRENTE, DE UM CENTESIMO DA TAXA MEDIA DO DOLAR COMERCIAL INTERBANCARIO DE
